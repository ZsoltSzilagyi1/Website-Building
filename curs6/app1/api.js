...
async function listProducts(products) {
  ...
  products.forEach(function (product) {
    ...
    if( product.product_colors[0]){
         culoare =product.product_colors[0].hex_value;
    }
    else{
        culoare='';
    ...
    let divProduct = `
        ...
        <div class="card mb-30"><a class="card-img-tiles" href="#" data-abc="true">
            ...
            <div class="card-body text-center">
                ...
                <p class="text-muted">Starting from ${product.price + 5}
                 ${culoare}</p>
                 <div style="display:inline-block;background-color:${culoare};height:20px;width:20px"></div>
